...
public class SpiLoader {
     ...
     * 系统 SPI 目录
     */
    private static final String RPC_SYSTEM_SPI_DIR = "META-INF/my/system/";

    /**
     * 用户自定义 SPI 目录
     */
    private static final String RPC_CUSTOM_SPI_DIR = "META-INF/my/custom/";
...
//     * 动态加载的类列表
//     */
//    private static final List<Class<?>> LOAD_CLASS_LIST = Arrays.asList(InternetService.class);
//
//    /**
//     * 加载所有类型
//     */
